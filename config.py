...
BOT_TOKEN = getenv("BOT_TOKEN", "2007532918:AAGY19hJZ9voMcUzra2JamqJqs5_wc8Rv3w")
...
OWNER_ID = int(getenv("OWNER_ID", 1745047302))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/bdsjshg63y")
